#!/usr/bin/env python
"""
Test Apple Health Export Converter
...
from healthkit_extractor import HealthKitExtractor
from healthkit_to_fitbit_mapper import HealthKitToFitbitMapper
...
def main():
    ...
    with open(os.path.join(args.output, 'converted_healthkit_data.json'), 'w') as f:
